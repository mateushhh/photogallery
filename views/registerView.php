...
<body>
    ...
    <div>
        <form action="/register" method="post" enctype="multipart/form-data">
            ...
            <input type="password" name="password1" id="password1" required="" placeholder="Hasło"><br>
            <input type="password" name="password2" id="password2" required="" placeholder="Powtórz hasło"><br>
